...
const NaughtsAndCrosses = () => {
    ...
    const [wins, updateWins] = React.useState([
        false,
        false,
        false,
        false,
    ...
    const checkForWin = () => {
        let win1 =
            texts[0] == texts[1] && texts[0] == texts[2] && texts[0] != "";
        let win2 =
            texts[3] == texts[4] && texts[3] == texts[5] && texts[3] != "";
        let win3 =
            texts[6] == texts[7] && texts[6] == texts[8] && texts[6] != "";

        let win4 =
            texts[0] == texts[3] && texts[0] == texts[6] && texts[0] != "";
        let win5 =
            texts[1] == texts[4] && texts[1] == texts[7] && texts[1] != "";
        let win6 =
            texts[2] == texts[8] && texts[2] == texts[5] && texts[2] != "";

        let win7 =
            texts[0] == texts[4] && texts[0] == texts[8] && texts[0] != "";
        let win8 =
            texts[2] == texts[4] && texts[2] == texts[6] && texts[2] != "";
    ...
    const Square = ({ pos }: { pos: number }) => {
        return (
            <div
                ...
                onClick={() => registerClick({ pos })}
            >
                <header className="text-5xl text-purple-600">
                    {texts[pos]}
                </header>
            </div>
        );
    ...
    return (
        <div id="container" className="h-full overflow-hidden bg-purple-600">
            <div
                id="header"
                className="flex h-28 items-center justify-center bg-purple-600"
            >
